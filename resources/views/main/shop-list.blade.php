...
{{--                                    </div>--}}
{{--                                    <div class="shop-list-content">--}}
{{--                                        <h3><a href="{{ url('/shop-details') }}">Simple things you to Save to Book</a></h3>--}}
{{--                                        <h5>$30.00</h5>--}}
{{--                                        <div class="star">--}}
{{--                                            <i class="fa-solid fa-star"></i>--}}
{{--                                            <i class="fa-solid fa-star"></i>--}}
...
{{--                                    </div>--}}
{{--                                    <div class="shop-list-content">--}}
{{--                                        <h3><a href="{{ url('/shop-details') }}">Qple Gpod with Retina Sisplay</a></h3>--}}
{{--                                        <h5>$39.00</h5>--}}
{{--                                        <div class="star">--}}
{{--                                            <i class="fa-solid fa-star"></i>--}}
{{--                                            <i class="fa-solid fa-star"></i>--}}
...
{{--                            <ul>--}}
{{--                                <li><a class="previous" href="{{ url('/shop-list') }}">Previous</a></li>--}}
{{--                                <li><a class="page-numbers" href="{{ url('/shop-list') }}">1</a></li>--}}
{{--                                <li><a class="page-numbers" href="{{ url('/shop-list') }}">2</a></li>--}}
{{--                                <li><a class="page-numbers" href="{{ url('/shop-list') }}">3</a></li>--}}
{{--                                <li><a class="page-numbers" href="{{ url('/shop-list') }}">...</a></li>--}}
{{--                                <li><a class="next" href="{{ url('/shop-list') }}">Next</a></li>--}}
{{--                            </ul>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
