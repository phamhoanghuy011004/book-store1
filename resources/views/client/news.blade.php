                        ...
                        <ul>
                            <li class="d-flex align-items-center">
                                ...
                                <div class="offcanvas__contact-text">
                                    <a target="_blank" href="news.html">Main Street, Melbourne, Australia</a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <div class="offcanvas__contact-text">
                                    <a target="_blank" href="news.html">Mod-friday, 09am -05pm</a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center">
                                <div class="offcanvas__contact-icon mr-15">
    ...
    <div class="header-top-1">
        <div class="container">
            <div class="header-top-wrapper">
                ...
                <ul class="list">
                    <li><i class="fa-light fa-comments"></i><a href="contact.blade.php">Live Chat</a></li>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <ul class="submenu">
                                                        ...
                                                        <li><a href="index-2.blade.php">Home 02</a></li>
                                                    </ul>
                                                </li>
                                                <li>
                    ...
                    <div class="identityBox">
                        <div class="form-wrapper">
                            ...
                            <div class="input-check remember-me">
                                ...
                                <div class="text"> <a href="index-2.blade.php">Forgot Your password?</a> </div>
                            </div>
                            <div class="loginBtn">
                                <a href="index-2.blade.php" class="theme-btn rounded-0"> Log in </a>
                            </div>
                    ...
                    <div class="news-standard-wrapper">
                        <div class="news-standard-items">
                            ...
                            <div class="news-content">
                                ...
                                <h3>
                                    <a href="news-details.blade.php">Top 10 Tarot Decks For The Tarot world Summit</a>
                                </h3>
                                <p>
                                ...
                                <a href="news-details.blade.php" class="theme-btn mt-4">
                                    Read More
                        ...
                        <div class="news-standard-items">
                            ...
                            <div class="news-content">
                                ...
                                <h3>
                                    <a href="news-details.blade.php">Eu parturient dictumst fames quam tempor</a>
                                </h3>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris efficitur et ipsum
                                    ut volutpat. Morbi a mollis felis. Nam consectetur lectus vel lorem facilisis, quis
                        ...
                        <div class="news-standard-items">
                            ...
                            <div class="news-content">
                                ...
                                <h3>
                                    <a href="news-details.blade.php">All Inclusive Ultimate Circle Island Day with Lunch </a>
                                </h3>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris efficitur et ipsum
                                    ut volutpat. Morbi a mollis felis. Nam consectetur lectus vel lorem facilisis, quis
                    ...
                    <div class="main-sidebar">
                        ...
                        <div class="single-sidebar-widget">
                            ...
                            <div class="news-widget-categories">
                                <ul>
                                    <li><a href="news-details.blade.php">Adventure</a> <span>(5)</span></li>
                                    <li><a href="news-details.blade.php">Education</a> <span>(3)</span></li>
                                    <li class="active"><a href="news-details.blade.php">Romance</a><span>(6)</span></li>
                                    <li><a href="news-details.blade.php">Modern Fiction</a> <span>(2)</span></li>
                                    <li><a href="news-details.blade.php">Contemporary</a> <span>(4)</span></li>
                                    <li><a href="news-details.blade.php">Art & Literature</a> <span>(7)</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="single-sidebar-widget">
                        ...
                        <div class="single-sidebar-widget">
                            ...
                            <div class="news-widget-categories">
                                <div class="tagcloud">
                                    ...
                                    <a href="news-details.blade.php">Books</a>
                                    <a href="news-details.blade.php">Tips & Tricks</a>
                                    <a href="news-details.blade.php">Adventure</a>
                                    <a href="news-details.blade.php">Education</a>
                                    <a href="news-details.blade.php">Store</a>
                                </div>
                            </div>
                        </div>
                    </div>
