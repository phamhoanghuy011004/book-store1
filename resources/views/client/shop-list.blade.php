                    ...
                    <div class="col-xl-12">
                        <div class="woocommerce-notices-wrapper wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="form-clt">
                                ...
                                <div class="icon-2">
                                    <a href="shop.blade.php"><i class="fa-sharp fa-regular fa-grid-2"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 wow fadeInUp" data-wow-delay=".3s">
                                ...
                                <div class="shop-list-items">
                                    ...
                                    <div class="shop-list-content">
                                        <h3><a href="shop-details.blade.php">Simple things you to Save to Book</a></h3>
                                        <h5>$30.00</h5>
                                        <div class="star">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                                ...
                                <div class="shop-list-items">
                                    ...
                                    <div class="shop-list-content">
                                        <h3><a href="shop-details.blade.php">Qple Gpod with Retina Sisplay</a></h3>
                                        <h5>$39.00</h5>
                                        <div class="star">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
