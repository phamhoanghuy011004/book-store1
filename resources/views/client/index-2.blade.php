                ...
                <div class="offcanvas__content">
                    ...
                    <div class="offcanvas__contact">
                        ...
                        <div class="header-button mt-4">
                            <a href="contact.blade.php" class="theme-btn text-center">
                    ...
                    <div class="row">
                                        ...
                                        <nav id="mobile-menu">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="submenu">
                                                        <li><a href="shop.blade.php">Shop Default</a></li>
                                                        <li><a href="shop-list.blade.php">Shop List</a></li>
                                                        <li><a href="shop-details.blade.php">Shop Details</a></li>
                                                        <li><a href="shop-cart.blade.php">Shop Cart</a></li>
                                                ...
                                                <li class="has-dropdown">
                                                    ...
                                                    <ul class="submenu">
                                                        ...
                                                        <li class="has-dropdown">
                                                            <a href="team.blade.php">
                                                                Author
                                                                <i class="fas fa-angle-down"></i>
                                                            </a>
                                                            <ul class="submenu">
                                                                <li><a href="team.blade.php">Author</a></li>
                                                                <li><a href="team-details.blade.php">Author Profile</a></li>
                                                            </ul>
                                                        </li>
                                                        <li><a href="faq.blade.php">Faq's</a></li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="submenu">
                                                        <li><a href="news-grid.blade.php">Blog Grid</a></li>
                                                        <li><a href="news.blade.php">Blog List</a></li>
                                                        <li><a href="news-details.blade.php">Blog Details</a></li>
                                                    </ul>
                                                </li>
                                                <li>
                        ...
                        <div class="col-6 col-xl-3">
                            <div class="header-right">
                                ...
                                <div class="menu-cart">
                                    <a href="wishlist.blade.php" class="cart-icon">
                                        <i class="fa-regular fa-heart"></i>
                                    </a>
                                    <a href="shop-cart.blade.php" class="cart-icon">
                ...
                <div class="col-12 col-xl-6 col-lg-6">
                    <div class="hero-items">
                        ...
                        <div class="book-image">
                            <img src="assets/img/hero/hero-book.png" alt="img">
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                    <div class="banner-book-card-items bg-cover"
                        ...
                        <div class="banner-book-content">
                            ...
                            <a href="shop-details.blade.php" class="theme-btn white-bg">Shop Now <i
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                    <div class="banner-book-card-items bg-cover"
                        ...
                        <div class="banner-book-content">
                            ...
                            <h6>15% Off on Kids' Toys and Gifts!</h6>
                            <a href="shop.blade.php" class="theme-btn white-bg">Shop Now <i
                                    class="fa-solid fa-arrow-right-long"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <section class="shop-section section-padding fix pt-0">
        <div class="container">
            <div class="section-title-area">
                ...
                <a href="shop.blade.php" class="theme-btn transparent-btn wow fadeInUp" data-wow-delay=".5s">Explore More <i
                        class="fa-solid fa-arrow-right-long"></i></a>
            </div>
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="shop-box-items style-2">
                            <div class="book-thumb center">
                                ...
                                <ul class="shop-icon d-grid justify-content-center align-items-center">
                                    <li>
                                        <a href="shop-cart.blade.php"><i class="far fa-heart"></i></a>
                                    </li>
                                    <li>
                                        <a href="shop-cart.blade.php">
                                            <img class="icon" src="assets/img/icon/shuffle.svg" alt="svg-icon">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="shop-details.blade.php"><i class="far fa-eye"></i></a>
                                    </li>
                                </ul>
                                <div class="shop-button">
                                    <a href="shop-details.blade.php" class="theme-btn"><i
                                            class="fa-solid fa-basket-shopping"></i> Add To Cart</a>
                                </div>
                            </div>
                            <div class="shop-content">
                                <h5> Design Low Book </h5>
                                <h3><a href="shop-details.blade.php">Simple Things You To <br> Save BOOK</a></h3>
                                <ul class="price-list">
                                    <li>$30.00</li>
                                    <li>
                                        <del>$39.99</del>
                    ...
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            ...
                            <div class="shop-content">
                                <h5> Design Low Book </h5>
                                <h3><a href="shop-details.blade.php">How Deal With Very <br> Bad BOOK</a></h3>
                                <ul class="price-list">
                                    <li>$39.00</li>
                                </ul>
                                <ul class="author-post">
                    ...
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            ...
                            <div class="shop-content">
                                <h5> Design Low Book </h5>
                                <h3><a href="shop-details.blade.php">The Hidden Mystery <br> Behind</a></h3>
                                <ul class="price-list">
                                    <li>
                                        $29.00
                                    </li>
                    ...
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            ...
                            <div class="shop-content">
                                <h5> Design Low Book </h5>
                                <h3><a href="shop-details.blade.php">Qple GPad With Retina <br> Sisplay</a></h3>
                                <ul class="price-list">
                                    <li>$19.00</li>
                                </ul>
                                <ul class="author-post">
                    ...
                    <div class="swiper-slide">
                        <div class="shop-box-items style-2">
                            ...
                            <div class="shop-content">
                                <h5> Design Low Book </h5>
                                <h3><a href="shop-details.blade.php">Flovely and Unicom <br> Erna</a></h3>
                                <ul class="price-list">
                                    <li>$30.00</li>
                                </ul>
                                <ul class="author-post">
            ...
            <div class="book-shop-wrapper style-2">
                <div class="shop-box-items style-3 wow fadeInUp" data-wow-delay=".2s">
                    ...
                    <div class="shop-content">
                        ...
                        <div class="shop-button">
                            <a href="shop-details.blade.php" class="theme-btn"><i class="fa-solid fa-basket-shopping"></i>
                                Add To Cart</a>
                        </div>
                    </div>
                </div>
                <div class="shop-box-items style-3 wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <div class="shop-content">
                        ...
                        <h3><a href="shop-details.blade.php">Qple GPad With <br> Retina Sisplay </a></h3>
                        <ul class="author-post">
                            <li class="authot-list">
                                <span class="content">Wilson</span>
                            </li>
                ...
                <div class="shop-box-items style-3 wow fadeInUp" data-wow-delay=".6s">
                    ...
                    <div class="shop-content">
                        ...
                        <h3><a href="shop-details.blade.php">Simple Things You <br> To Save BOOK </a></h3>
                        <ul class="author-post">
                            <li class="authot-list">
                                <span class="content">Wilson</span>
                            </li>
    ...
    <section class="cta-banner-section fix section-padding pt-0">
        <div class="container">
            <div class="cta-banner-wrapper style-2 section-padding bg-cover"
                style="background-image: url('assets/img/cta-banner2.jpg');">
                ...
                <div class="cta-content text-left">
                    <h2 class="text-white mb-40 wow fadeInUp" data-wow-delay=".3s">Get 25% discount in all <br> kind of
                        super Selling</h2>
                    <a href="shop.blade.php" class="theme-btn white-bg wow fadeInUp" data-wow-delay=".5s">Shop Now <i
                            class="fa-solid fa-arrow-right-long"></i></a>
                </div>
            </div>
        </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            ...
                            <div class="team-content text-center">
                                <h6><a href="team-details.blade.php">Esther Howard</a></h6>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            ...
                            <div class="team-content text-center">
                                <h6><a href="team-details.blade.php">Shikhon Islam</a></h6>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            ...
                            <div class="team-content text-center">
                                <h6><a href="team-details.blade.php">Kawser Ahmed</a></h6>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            ...
                            <div class="team-content text-center">
                                <h6><a href="team-details.blade.php">Brooklyn Simmons</a></h6>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            ...
                            <div class="team-content text-center">
                                <h6><a href="team-details.blade.php">Leslie Alexander</a></h6>
                    ...
                    <div class="swiper-slide">
                        <div class="team-box-items">
                            ...
                            <div class="team-content text-center">
                                <h6><a href="team-details.blade.php">Guy Hawkins</a></h6>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="news-card-items">
                        ...
                        <div class="news-content">
                            ...
                            <h3><a href="news-details.blade.php">Montes suspendisse massa curae malesuada</a></h3>
                            <a href="news-details.blade.php" class="theme-btn-2">Read More <i
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                    <div class="news-card-items">
                        ...
                        <div class="news-content">
                            ...
                            <h3><a href="news-details.blade.php">Playful Picks Paradise: Kids’ Essentials with Dash.</a></h3>
                            <a href="news-details.blade.php" class="theme-btn-2">Read More <i
                                    class="fa-regular fa-arrow-right-long"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                    <div class="news-card-items">
                        ...
                        <div class="news-content">
                            ...
                            <h3><a href="news-details.blade.php">Tiny Emporium: Playful Picks for Kids’ Delightful Days.</a>
                            </h3>
                            <a href="news-details.blade.php" class="theme-btn-2">Read More <i
                                    class="fa-regular fa-arrow-right-long"></i></a>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                    <div class="news-card-items">
                        ...
                        <div class="news-content">
                            ...
                            <h3><a href="news-details.blade.php">Eu parturient dictumst fames quam tempor</a></h3>
                            <a href="news-details.blade.php" class="theme-btn-2">Read More <i
                                    class="fa-regular fa-arrow-right-long"></i></a>
                        </div>
                    </div>
