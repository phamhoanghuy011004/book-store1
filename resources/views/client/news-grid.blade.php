                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="news-card-items style-2 mt-0">
                        ...
                        <div class="news-content">
                            ...
                            <h3><a href="news-details.blade.php">Top 5 Tarot Decks for the Tarot World Summit</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                    <div class="news-card-items style-2 mt-0">
                        ...
                        <div class="news-content">
                            ...
                            <h3><a href="news-details.blade.php">Behind the Scenes with Author Victoria Aveyard</a></h3>
                            <a href="news-details.blade.php" class="theme-btn-2">Read More <i
                                    class="fa-regular fa-arrow-right-long"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="news-card-items style-2 mt-0">
                        ...
                        <div class="news-content">
                            ...
                            <h3><a href="news-details.blade.php">How to Keep Children Safe Online In Simple Steps</a></h3>
                            <a href="news-details.blade.php" class="theme-btn-2">Read More <i
                                    class="fa-regular fa-arrow-right-long"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                    <div class="news-card-items style-2 mt-0">
                        ...
                        <div class="news-content">
                            ...
                            <h3><a href="news-details.blade.php">That jerk Form Finance
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                    <div class="news-card-items style-2 mt-0">
                        ...
                        <div class="news-content">
                            ...
                            <h3><a href="news-details.blade.php">Students Intelligence in Education Building Resilient</a>
                            </h3>
                            <a href="news-details.blade.php" class="theme-btn-2">Read More <i
                                    class="fa-regular fa-arrow-right-long"></i></a>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                    <div class="news-card-items style-2 mt-0">
                        ...
                        <div class="news-content">
                            ...
                            <h3><a href="news-details.blade.php">From without content
                                    style without </a></h3>
                            <a href="news-details.blade.php" class="theme-btn-2">Read More <i
                                    class="fa-regular fa-arrow-right-long"></i></a>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="news-card-items style-2 mt-0">
                        ...
                        <div class="news-content">
                            ...
                            <h3><a href="news-details.blade.php">All Inclusive Ultimate Circle Island Day with Lunch</a></h3>
                            <a href="news-details.blade.php" class="theme-btn-2">Read More <i
                                    class="fa-regular fa-arrow-right-long"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                    <div class="news-card-items style-2 mt-0">
                        ...
                        <div class="news-content">
                            ...
                            <h3><a href="news-details.blade.php">Top 10 Tarot Decks for the Tarot World Summit</a></h3>
                            <a href="news-details.blade.php" class="theme-btn-2">Read More <i
                                    class="fa-regular fa-arrow-right-long"></i></a>
                        </div>
                    </div>
