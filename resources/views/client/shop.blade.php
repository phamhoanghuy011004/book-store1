                    ...
                    <div class="col-12">
                        <div class="woocommerce-notices-wrapper wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="form-clt">
                                ...
                                <div class="icon">
                                    <a href="shop-list.blade.php"><i class="fas fa-list"></i></a>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                                        <div class="shop-box-items">
                                            <div class="book-thumb center">
                                                <a href="shop-details.blade.php"><img src="assets/img/book/01.png" alt="img"></a>
                                                <ul class="post-box">
                                                    <li>
                                                        Hot
                                                    </li>
                                            ...
                                            <div class="shop-content">
                                                <h3><a href="shop-details.blade.php">Simple Things You Save BOOK</a></h3>
                                                <ul class="price-list">
                                                    <li>$30.00</li>
                                                    <li>
                                                        <i class="fa-solid fa-star"></i>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                                        <div class="shop-box-items">
                                            ...
                                            <div class="shop-content">
                                                <h3><a href="shop-details.blade.php">How Deal With Very Bad BOOK</a></h3>
                                                <ul class="price-list">
                                                    <li>$39.00</li>
                                                    <li>
                                                        <i class="fa-solid fa-star"></i>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                                        <div class="shop-box-items">
                                            ...
                                            <div class="shop-content">
                                                <h3><a href="shop-details.blade.php">The Hidden Mystery Behind</a></h3>
                                                <ul class="price-list">
                                                    <li>
                                                        $30.00
                                                        <del>$39.99</del>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                                        <div class="shop-box-items">
                                            ...
                                            <div class="shop-content">
                                                <h3><a href="shop-details.blade.php">Qple GPad With Retina Sisplay</a></h3>
                                                <ul class="price-list">
                                                    <li>$39.00</li>
                                                    <li>
                                                        <i class="fa-solid fa-star"></i>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                                        <div class="shop-box-items">
                                            ...
                                            <div class="shop-content">
                                                <h3><a href="shop-details.blade.php">Flovely and Unicom Erna</a></h3>
                                                <ul class="price-list">
                                                    <li>$19.00</li>
                                                    <li>
                                                        <i class="fa-solid fa-star"></i>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                                        <div class="shop-box-items">
                                            ...
                                            <div class="shop-content">
                                                <h3><a href="shop-details.blade.php">Castle In The Sky</a></h3>
                                                <ul class="price-list">
                                                    <li>$16.00</li>
                                                    <li>
                                                        <i class="fa-solid fa-star"></i>
